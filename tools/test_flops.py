        ...
        with torch.cuda.amp.autocast(enabled=amp):
            with torch.no_grad():
                for _ in range(num_iters):
                    ...
                    flops, params = profile(self.model, inputs=(data,))
...
if __name__ == '__main__':
    wrapper = Wrapper(
        cfg='work_dirs/raydn_r50_704_bs2_seq_428q_nui_60e/raydn_r50_704_bs2_seq_428q_nui_60e.py',
        checkpoint='work_dirs/raydn_r50_704_bs2_seq_428q_nui_60e/latest.pth'
    )
