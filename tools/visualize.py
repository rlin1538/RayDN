...
use_gt = False
out_dir = './result_vis/'
result_json = "/home/rlin/code/RayDN/test/height_map_grid01_denoiser_800_for_test/Tue_May__6_11_06_53_2025/pts_bbox/results_nusc"
...
for token in tqdm.tqdm(tokens[100:500]):
    if use_gt:
